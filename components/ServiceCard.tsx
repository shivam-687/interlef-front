...
const ServiceCard = ({ title, description, image }: ServiceCardProps) => {
    return (
        <>
            <div className="flex flex-col lg:flex-row justify-center items-center py-8 group mt-8 md:mt-0 p-5 rounded-lg shadow-md shadow-primary/20 group hover:bg-primary hover:text-white border-2 border-transparent hover:border-secondary transition duration-300 ">
